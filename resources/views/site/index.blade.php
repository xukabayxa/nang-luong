            ...
            <div uk-grid class="uk-grid uk-grid-large uk-child-width-expand@m uk-flex-middle  uk-wysiwyg-default" uk-scrollspy="target: .uk-animation-item; cls: uk-animation-slide-bottom-small; delay: 250; repeat: true;">
                <div class="uk-animation-parent">
                    ...
                    <div class="uk-margin-top">
                        <a class="uk-button uk-color-light uk-style-secondary-b " href="https://www.agpgroup.com/about-us/what-we-do/">
            ...
            <div>
                <div class="uk-grid uk-grid-large" uk-grid>
                    ...
                    <div class="uk-width-expand@m" uk-scrollspy="cls: uk-animation-fade; delay: 700;">
                        ...
                        <a class="uk-button uk-color-tertiary uk-style-secondary-b " href="https://www.agpgroup.com/about-us/un-sdgs/">
        ...
        <div class="uk-container uk-container-xmedium">
            <div class="uk-grid uk-grid-large uk-position-relative" uk-grid>
                ...
                <div class="uk-width-expand@m" uk-scrollspy="cls: uk-animation-fade; delay: 700;">
                    ...
                    <a class="uk-button uk-color-tertiary uk-style-secondary-b " href="https://www.agpgroup.com/about-us/what-we-do/">
        ...
        <div uk-grid class="uk-grid-large uk-grid-match ajax-results uk-grid uk-child-width-1-3@l uk-child-width-1-2@m" uk-scrollspy="target: > div; cls: uk-animation-slide-bottom-small; delay: 320;">
            <div class="uk-feat-article">
                <div>
                    <div class="uk-cover-container uk-margin-small-bottom">
                        ...
                        <img data-src="https://media.agpgroup.com/uploads/2022/03/SOLAR-IMAGE-PR-17-MARCH-scaled.jpg?w=1024&h=384&scale.option=fill&cw=1024&ch=384&cx=center&cy=center" data-options="quality:80;hdQuality:60;resize:1;fit:cover;autostart:visible;" class=" Sirv uk-utility-object-fit-cover " alt="SOLAR-IMAGE-PR-17-MARCH-scaled.jpg?w=1024&h=384&scale" title="SOLAR-IMAGE-PR-17-MARCH-scaled.jpg?w=1024&h=384&scale" />
                    </div>
            ...
            <div class="uk-feat-article">
                <div>
                    <div class="uk-cover-container uk-margin-small-bottom">
                        <canvas width="460" height="370"></canvas>
                        <img data-src="https://media.agpgroup.com/uploads/2022/03/ASE-EAL-Header-Image.png?w=1024&h=505&scale.option=fill&cw=1024&ch=505&cx=center&cy=center" data-options="quality:80;hdQuality:60;resize:1;fit:cover;autostart:visible;" class=" Sirv uk-utility-object-fit-cover " alt="ASE-EAL-Header-Image.png?w=1024&h=505&scale" title="ASE-EAL-Header-Image.png?w=1024&h=505&scale" />
                    </div>
                    <div class="uk-flex uk-flex-between uk-style-secondary-m uk-text-ls-1 uk-text-dark uk-text-12 uk-margin-small-bottom uk-padding-xsmall-top">
                        <div>11.03.22</div>
                        <div></div>
            ...
            <div class="uk-feat-article">
                <div>
                    <div class="uk-cover-container uk-margin-small-bottom">
                        <canvas width="460" height="370"></canvas>
                        <img data-src="https://media.agpgroup.com/uploads/2019/06/iStock-1032683612-scaled.jpg?w=1024&h=683&scale.option=fill&cw=1024&ch=683&cx=center&cy=center" data-options="quality:80;hdQuality:60;resize:1;fit:cover;autostart:visible;" class=" Sirv uk-utility-object-fit-cover " alt="iStock-1032683612-scaled.jpg?w=1024&h=683&scale" title="iStock-1032683612-scaled.jpg?w=1024&h=683&scale" />
                    </div>
                    <div class="uk-flex uk-flex-between uk-style-secondary-m uk-text-ls-1 uk-text-dark uk-text-12 uk-margin-small-bottom uk-padding-xsmall-top">
                        <div>16.02.22</div>
                        <div></div>
