        ...
        <div class="uk-container">
            <section id="primary" class="content-full-width">    <!-- #post-8 -->
                <div class="content-pane-wrap-body">
                                            ...
                                            <div class="body-leader man-2" style="margin-left: 0;">
                                                <div class="conver-data">
                                                    @if(App::isLocale('vi'))
                                                        <div class="content-text" data-content=""
                                                             style="padding: 0; color:#0F4C81">Ông<b> Saumya
                                                                Swain<b></b></b></div>
                                                    ...
                                                    @else
                                                        <div class="content-text" data-content=""
                                                             style="padding: 0; color:#0F4C81">Mr<b> Saumya Swain<b></b></b>
                                                        </div>
                                                ...
                                                @if(App::isLocale('vi'))
                                                    ...
                                                    <div>
                                                        ...
                                                        <ul>
                                                            <li>6/2020 đến nay: Sáng lập và điều hành RT Energy PTE
                                                                LTD-Singapore
                                                            </li>
                                                            <li>8/2019-5/2020: Cổ đông sáng lập, cố vấn cấp cao Indefol
                                                                Solar
                                                            </li>
                                                ...
                                                @else
                                                    ...
                                                    <div>
                                                        ...
                                                        <ul>
                                                            <li>6/2020 to present: Founding and operating RT Energy PTE
                                                                LTD-Singapore
                                                            </li>
                                                            <li>8/2019-5/2020: Founding shareholder, senior advisor
                                                                Indefol Solar
                                                            </li>
                                            ...
                                            <div class="body-leader">
                                                @if(App::isLocale('vi'))
                                                    <div class="conver-data man-1">
                                                        <div class="content-text" data-content="Ông Đỗ Minh Phú"
                                                             style="padding: 0; color: #0F4C81 ">Ông <b>Tạ Anh Tuấn
                                                                <b></b></b></div>
                                                        <div class="detail-content-text" style="color: #0F4C81 ">
                                                    ...
                                                    <div>
                                                        <p class="cong-tac">Quá trình công tác:</p>
                                                        <ul>
                                                            <li>Từ cuối năm 2021 đến nay: Tổng giám đốc, Adani Solar và
                                                                Adani Wind Power Co.,Ltd
                                                            </li>
                                                            <li>1/2020 đến nay: Tổng Giám đốc, đồng sáng lập RT Energy
                                                            </li>
                                                            <li>9/2018: Cố vấn trưởng phát triển năng lượng tái tại Tập
                                                                đoàn thép Đại Dũng
                                                            </li>
                                                            <li>4/2015: Chủ tịch kiêm Tổng Giám đốc Công ty TNHH Đầu tư
                                                                và phát triển Clavie
                                                            </li>
                                                            <li>10/2011-3/2013: Giám đốc đại lý miền Bắc Công ty TNHH
                                                                Honda Việt Nam
                                                            </li>
                                                            <li>9/2010-9/2011: Giám đốc Nhà phân phối Công ty TNHH
                                                                Unilever Việt Nam
                                                            </li>
                                                        </ul>
                                                    </div>
                                                @else
                                                    <div class="conver-data man-1">
                                                        <div class="content-text" data-content="Ông Đỗ Minh Phú"
                                                             style="padding: 0; color: #0F4C81 ">Mr. <b>Ta Anh Tuan
                                                                <b></b></b></div>
                                                        <div class="detail-content-text" style="color: #0F4C81 ">
                                                    ...
                                                    <div>
                                                        <p class="cong-tac">Experience:</p>
                                                        <ul>
                                                            <li>From the end of 2021 to present: General Director, Adani
                                                                Solar and Adani Wind Power Co.,Ltd
                                                            </li>
                                                            <li>January 2020 to present: CEO, co-founder of RT Energy
                                                            </li>
                                                            <li>September 2018: Renewable energy consultant at Dai Dung
                                                                Steel Corporation
                                                            </li>
                                                            <li>April 2015: Chairman and General Director of Clavie
                                                                Investment and Development Co., Ltd
                                                            </li>
                                                            <li>10/2011-3/2013: Dealer director in the North of Honda
                                                                Vietnam Co., Ltd
                                                            </li>
                                                            <li>9/2010-9/2011: Distributor Director of Unilever Vietnam
                                                                Co., Ltd
                                                            </li>
                                                        </ul>
                                                    </div>
                                        ...
                                        <div class="leader-box" id="group-do-minh-phu"
                                            ...
                                            <div class="body-leader man-2" style="margin-left: 0;">
                                                @if(App::isLocale('vi'))
                                                    <div class="conver-data">
                                                        <div class="content-text" data-content="Ông Đỗ Minh Phú"
                                                             style="padding: 0; color:#0F4C81">Ông<b> Nguyễn Đức
                                                                Dũng<b></b></b></div>
                                                        <div class="detail-content-text" style="color:#0F4C81;">
                                                    ...
                                                    <div class="detail-leader">
                                                        <p>Ông Nguyễn Đức Dũng là doanh nhân dày dặn kinh nghiệm trong
                                                    ...
                                                    <div>
                                                        ...
                                                        <ul>
                                                            ...
                                                            <li>1/2019 đến nay: Tổng giám đốc, Đồng sáng lập Novus
                                                                Imperium Corporation
                                                            </li>
                                                            <li>09/2014-12/2020: Giám đốc Tài chính và Tiếp thị Công ty
                                                                Cổ phần Dược phẩm Hà Nội
                                                            </li>
                                                            <li>09/2014 đến nay: Giảng viên cao cấp Khoa Kinh doanh Quốc
                                                                tế - Học viện Ngân hàng – Ngân hàng Nhà nước Việt Nam
                                                            </li>
                                                            <li>09/2011 đến nay: Đồng sáng lập CGD Victory Education
                                                                Group

                                                            </li>
                                                            <li> 11/2011-09/2014: Quản lý Đầu tư kinh doanh Lãi suất và
                                                                Forex
                                                            </li>
                                                ...
                                                @else
                                                    <div class="conver-data">
                                                        <div class="content-text" data-content="Ông Đỗ Minh Phú"
                                                             style="padding: 0; color:#0F4C81">Mr.<b> Nguyen Duc
                                                                Dung<b></b></b></div>
                                                        <div class="detail-content-text" style="color:#0F4C81;">
                                                    ...
                                                    <div class="detail-leader">
                                                        <p>Mr. Nguyen Duc Dung is an experienced businessman in the
                                                    ...
                                                    <div>
                                                        <p class="cong-tac">Experience:</p>
                                                        <ul>
                                                            <li>January 2020 to present: Deputy General Director of RT
                                                                Energy
                                                            </li>
                                                            <li>January 2019 to present: General Director, Co-Founder of
                                                                Novus Imperium Corporation
                                                            </li>
                                                            <li>09/2014-12/2020: Finance and Marketing Director of Hanoi
                                                                Pharmaceutical Joint Stock Company
                                                            </li>
                                                            <li>September 2014 to present: Senior Lecturer at Faculty of
                                                                International Business - Banking Academy - State Bank of
                                                                Vietnam
                                                            </li>
                                                            <li>September 2011 to present: Co-founder of CGD Victory
                                                                Education Group
                                                            </li>
                                                            <li>11/2011-09/2014: Interest and Forex Business Investment
                                                                Manager, Bank for Investment and Development of Vietnam
                                                            </li>
                    ...
                    @else
                        @foreach($regents as $index => $regent)
                            @if($index % 2 == 0)
                                <div class="leader-body d-flex">
                                    <div id="page-content-wrapper">
                                        <div class="leader load-data active-show"
                                                ...
                                                <div class="leader-box" id="group-do-minh-phu"
                                                    ...
                                                    <div class="body-leader man-2" style="margin-left: 0;">
                                                        <div class="conver-data">
                                                            @if(App::isLocale('vi'))
                                                                <div class="content-text" data-content=""
                                                                     style="padding: 0; color:#0F4C81">Ông<b> {{$regent->regentVi->full_name}}
                                                                        <b></b></b></div>

                                                                <div class="detail-content-text" style="color:#0F4C81;">
                                                                    {{$regent->regentVi->role}}
                                                                </div>
                                                            @else
                                                                <div class="content-text" data-content=""
                                                                     style="padding: 0; color:#0F4C81">Mr<b> {{$regent->regentEn->full_name ?? ''}}<b></b></b>
                                                                </div>

                                                                <div class="detail-content-text" style="color:#0F4C81;">
                                                                    {{$regent->regentEn->role ?? ''}}
                                                                </div>
                                                            @endif
                                                ...
                                                <div class="leader-box" id="group-do-minh-phu"
                                                    ...
                                                    <div class="body-leader">
                                                        ...
                                                        @else
                                                            <div class="conver-data man-1">
                                                                <div class="content-text" data-content="Ông Đỗ Minh Phú"
                                                                     style="padding: 0; color: #0F4C81 ">Mr. <b>{{$regent->regentEn->full_name ?? ''}}
                                                                        <b></b></b></div>
                                                                <div class="detail-content-text" style="color: #0F4C81 ">
                                                                    {{$regent->regentEn->role ?? ''}}
                                                                </div>
