            ...
            <div class="uk-section uk-section-large uk-margin-auto uk-width-1-1" style="padding-top: 4em">
                <div class="uk-container uk-container-xmedium">
                    <div class="uk-style-primary-l uk-text-3 uk-text-lh-4 uk-style-hline large uk-width-xmedium"
                        ...
                        {{App::isLocale('vi') ? 'Các khu công nghiệp có lợi thế về diện tích áp mái lớn, nên nếu đầu tư điện mặt trời, doanh nghiệp sẽ được hưởng lãi kép. Ngoài việc được sử dụng điện miễn phí, khi dôi dư, doanh nghiệp có thể bán cho ngành Điện.
	RT Energy hướng tới hợp tác với các khu chế xuất, khu công nghiệp, xây dựng mô hình Khu công nghiệp kết hợp năng lượng tái tạo nhằm tận dụng tối đa nguồn năng lượng sạch, đem lại hiệu quả kinh tế và môi trường bền vững' : 'Studying for implementation'}}
                    </div>
                </div>
            </div>
        </div>
