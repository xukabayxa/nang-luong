                    ...
                    <div>
                        <div class="textwidget">
                            <div class="sec-title pb-4">
                                <h3 class="text-white h5 text-uppercase">HEAD OFFICE - Ha Noi</h3>
                            </div>
                            <ul class="list-unstyled mb-0">
                                <li class="mb-3"><i class="far fa-envelope text-primary display-25 mr-3"></i>{{ $config->email }}</li>
                                <li class="mb-3"><i class="fas fa-mobile-alt text-primary display-25 mr-3"></i>{{ $config->hotline }}</li>
                                <li><i class="fas fa-map-marker-alt text-primary display-25 mr-3"></i>Spring Heirs Tower, No. 9/82 Dich Vong Hau, Cau Giay, Hanoi</li>
                            </ul>
                        </div>
		            </div>
                </div>
            ...
            <div class="col-lg-5 mt-3 wow fadeIn" data-wow-delay="180ms" style="visibility: visible; animation-delay: 200ms; animation-name: fadeIn;">
                <div>
                    <div>
                        <div class="textwidget">
                            <div class="sec-title pb-4">
                                <h3 class="text-white h5 text-uppercase">Branch - Ho Chi Minh city</h3>
                            </div>
                            <ul class="list-unstyled mb-0">
                                <li class="mb-3"><i class="far fa-envelope text-primary display-25 mr-3"></i>{{ $config->email }}</li>
                                <li class="mb-3"><i class="fas fa-mobile-alt text-primary display-25 mr-3"></i>{{ $config->hotline }}</li>
                ...
                <div>
                    <div class="textwidget">
                        ...
                        <ul class="footer-link mb-0 list-unstyled">
                            ...
                            <li class="mb-3"><a href="#">Our global presence</a></li>
                            <li class="mb-3"><a href="#">Insights</a></li>
